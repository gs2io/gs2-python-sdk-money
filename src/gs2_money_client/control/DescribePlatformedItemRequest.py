...
class DescribePlatformedItemRequest(Gs2BasicRequest):

    class Constant(Gs2Money):
        FUNCTION = "DescribePlatformedItem"
    ...
    def __init__(self, params=None):
        ...
        """
        super(DescribePlatformedItemRequest, self).__init__(params)
        if params is None:
    ...
    def with_money_name(self, money_name):
        ...
        :type money_name: unicode
        :return: this
        :rtype: DescribePlatformedItemRequest
        """
