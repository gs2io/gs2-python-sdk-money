...
class CreateMoneyRequest(Gs2BasicRequest):
    ...
    def set_priority(self, priority):
        ...
        """
        if priority is not None and not (isinstance(priority, str) or isinstance(priority, unicode)):
    ...
    def set_share_free(self, share_free):
        ...
        """
        if share_free is not None and not isinstance(share_free, bool):
    ...
    def set_currency(self, currency):
        ...
        """
        if currency is not None and not (isinstance(currency, str) or isinstance(currency, unicode)):
    ...
    def set_use_verify_receipt(self, use_verify_receipt):
        ...
        """
        if use_verify_receipt is not None and not isinstance(use_verify_receipt, bool):
    ...
    def set_apple_key(self, apple_key):
        ...
        """
        if apple_key is not None and not (isinstance(apple_key, str) or isinstance(apple_key, unicode)):
    ...
    def set_google_key(self, google_key):
        ...
        """
        if google_key is not None and not (isinstance(google_key, str) or isinstance(google_key, unicode)):
    ...
    def set_create_wallet_trigger_script(self, create_wallet_trigger_script):
        ...
        """
        if create_wallet_trigger_script is not None and not (isinstance(create_wallet_trigger_script, str) or isinstance(create_wallet_trigger_script, unicode)):
    ...
    def set_create_wallet_done_trigger_script(self, create_wallet_done_trigger_script):
        ...
        """
        if create_wallet_done_trigger_script is not None and not (isinstance(create_wallet_done_trigger_script, str) or isinstance(create_wallet_done_trigger_script, unicode)):
    ...
    def set_charge_wallet_trigger_script(self, charge_wallet_trigger_script):
        ...
        """
        if charge_wallet_trigger_script is not None and not (isinstance(charge_wallet_trigger_script, str) or isinstance(charge_wallet_trigger_script, unicode)):
    ...
    def set_charge_wallet_done_trigger_script(self, charge_wallet_done_trigger_script):
        ...
        """
        if charge_wallet_done_trigger_script is not None and not (isinstance(charge_wallet_done_trigger_script, str) or isinstance(charge_wallet_done_trigger_script, unicode)):
    ...
    def set_consume_wallet_trigger_script(self, consume_wallet_trigger_script):
        ...
        """
        if consume_wallet_trigger_script is not None and not (isinstance(consume_wallet_trigger_script, str) or isinstance(consume_wallet_trigger_script, unicode)):
    ...
    def set_consume_wallet_done_trigger_script(self, consume_wallet_done_trigger_script):
        ...
        """
        if consume_wallet_done_trigger_script is not None and not (isinstance(consume_wallet_done_trigger_script, str) or isinstance(consume_wallet_done_trigger_script, unicode)):
